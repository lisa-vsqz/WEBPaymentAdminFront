...
export default function ListUsers() {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <LogoutButton />
      <button
        onClick={() => router.push("/admin/bankaccounts")}
        className="mb-4 ml-4 px-4 py-2 bg-[#165585] text-white rounded hover:bg-blue-800"
      >
        Bank Accounts
      </button>
      <button
      ...
      <button
        onClick={() => router.push("/admin/providerhistory")}
        className="mb-4 ml-4 px-4 py-2 bg-[#165585] text-white rounded hover:bg-blue-800"
      >
        Provider History
      </button>
      <button
        onClick={() => router.push("/admin/liquidityanalysis")}
        className="mb-4 ml-4 mr-4 px-4 py-2 bg-[#165585] text-white rounded hover:bg-blue-800"
      >
        Liquidity Analysis
      </button>
